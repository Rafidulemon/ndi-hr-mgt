...
export const organizations: SeedOrganization[] = [
  {
    ...
    timezone: "Asia/Dhaka",
    locale: "en-US",
    orgAdminUserId: "org-admin-kohei",
    managerUserId: "org-manager-tabuchi",
  },
];
  ...
  [NDI_ORG_ID]: [
    {
      id: "team-management",
      name: "Management",
      description: "Executive leadership and HR operations.",
    ...
    },
    {
      id: "team-design",
      name: "Design",
      description: "Product design, UX, and brand systems.",
...
export const usersToCreate: SeedUserConfig[] = [
  ...
  },
  {
    ...
    teamId: "team-management",
    workModel: "HYBRID",
    reportingManagerId: "org-admin-kohei",
    gender: "MALE",
    ...withPhones(1002),
  },
  {
    ...
    departmentId: "dept-engineering",
    workModel: "HYBRID",
    reportingManagerId: "org-manager-tabuchi",
    gender: "MALE",
    ...withPhones(1003),
  },
  {
  ...
  },
  {
    ...
    teamId: "team-design",
    workModel: "HYBRID",
    reportingManagerId: "designer-lead-tahmina",
    gender: "MALE",
    ...withPhones(1016),
  },
  {
...
export const teamLeadAssignments: Array<{ teamId: string; leadId: string }> = [
  { teamId: "team-management", leadId: "org-manager-tabuchi" },
  { teamId: "team-frontend", leadId: "frontend-lead-hazrat" },
  { teamId: "team-backend", leadId: "backend-lead-sufi" },
  { teamId: "team-design", leadId: "designer-lead-tahmina" },
];
...
export const teamManagerAssignments: Array<{ managerId: string; teamIds: string[] }> = [
  ...
  {
    managerId: "org-manager-tabuchi",
    teamIds: ["team-management"],
  },
];
